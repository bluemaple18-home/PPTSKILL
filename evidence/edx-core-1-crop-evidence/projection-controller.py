...
out = repo / 'evidence/edx-core-1-crop-evidence/projection-host-01'
...
receipt['scope'] = 'Crop CSS projection prototype；不是本卡production browser/PGQ驗收'
...
try:
    ...
    for key,args,limit in [
        ('cropProjection',[node,'evidence/edx-core-1-crop-evidence/projection-browser-probe.mjs',str(out/'projection')],120)]:
