...
out = repo / 'evidence/edx-core-1-crop-evidence/host-acceptance-02'
...
receipt['scope'] = 'Core 1 Crop product acceptance；prototype不混入本輪'
...
try:
    ...
    for key,args,limit in [
        ('cropBrowser',[node,'tools/edx-wp1-s4-browser-acceptance.mjs',str(out/'crop'),'--crop-regression'],900),
