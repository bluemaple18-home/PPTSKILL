...
out = repo / 'evidence/edx-core-1-crop-evidence/dialog-visual-host-01'
...
receipt['scope'] = 'Core 1 Crop dialog visual supplement；產品/PGQ已通過，不重跑'
...
try:
    ...
    for key,args,limit in [('dialogVisual',[node,'evidence/edx-core-1-crop-evidence/dialog-visual-probe.mjs',str(out/'dialog')],180)]:
