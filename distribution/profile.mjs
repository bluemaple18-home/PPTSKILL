...
import { loadLocalProfile, resolveProfilePath, saveLocalProfile } from './core/runtime/local-profile.js';
...
try {
  ...
  if (command === 'path') {
    ...
    throw new Error('用法：node profile.mjs <path|show|save> [--input profile.json --remember]');
  }
} catch (error) {
