...
**WP2-S11 BROWSER ACCEPTANCE BLOCKED：** layout單張圖片file drop，沿S9 adapter/S10 defaults與busy；無clipboard/多檔/crop/schema。卡tasks/edx-wp2-s11-image-drop.md。Base S10 closure da6c122（未merge）；main/origin-main仍d0b9aa0。
