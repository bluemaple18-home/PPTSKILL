...
export function addCropFixture(spec){
 ...
 slide.composition.geometryOverrides={...slide.composition.geometryOverrides,'crop-landscape':{x:120,y:220,width:600,height:280},'crop-portrait':{x:1000,y:220,width:250,height:400}};
