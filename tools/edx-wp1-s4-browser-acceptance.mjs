...
if (process.argv.includes('--asset-replacement-regression') || process.argv.includes('--targeted-image-file-regression') || process.argv.includes('--selected-image-regression') || process.argv.includes('--image-fit-regression') || process.argv.includes('--insert-image-regression') || process.argv.includes('--insert-image-file-regression')) addAssetReplacementFixture(input);
