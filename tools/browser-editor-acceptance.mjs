...
try {
  ...
  const interaction = await evaluate(String.raw`(async()=>{
    ...
    return {afterDuplicate,afterDelete,unsupportedChartRejection,chartTypeAfterRejection,imageReplaced,html,title:title.textContent,spec:window.PPTSKILLEditor.getDeckSpec()};
  })()`);
